import "./ChangeCreditProfile.css";
...
function ChangeCreditProfile({ user }) {
    ...
    return (
        <div className="ChangeCreditProfile">
            <h2 className="card-title">Actualizar Datos Crediticios</h2>
            <hr></hr>
...
export default ChangeCreditProfile;